...
function rwAdapt!(algo::MAlgoABCPT, ACC::Bool, ch::Int64)
    ...
    if algo.i==1
        ...
        algo.MChains[ch].infos[algo.i,:accept_rate] = algo.i>100 ?
               sum(algo.MChains[ch].infos[algo.i-100:algo.i,:accept])/100 :
               sum(algo.MChains[ch].infos[1:algo.i:accept])/algo.i
